        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Service/Booking Inquiries</h3>
                <p className="text-gray-600">info@berlinluxerentals.de</p>
              ...
              <div>
                ...
                <p className="text-gray-600">24/7 Support: +49 (30) 9876-5432</p>
              </div>
            </div>
          </motion.div>
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-primary-600 hover:bg-primary-700 disabled:bg-primary-400 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 flex items-center justify-center"
                >
                  {isSubmitting ? (
                    <>
