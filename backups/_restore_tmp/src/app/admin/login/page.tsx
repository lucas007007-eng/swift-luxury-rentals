        ...
        <div className="w-full max-w-md bg-black/70 border border-amber-500/30 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input value={username} onChange={e=>setUsername(e.target.value)} className="w-full bg-black/60 border border-white/20 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-amber-400" />
            </div>
            <div>
